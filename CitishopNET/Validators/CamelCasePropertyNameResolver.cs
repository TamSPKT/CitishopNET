...
namespace CitishopNET.Validators
{
	/// <summary>
	/// Convert property names to camelCase as Asp.Net Core does in
	/// <see href="https://github.com/FluentValidation/FluentValidation/issues/226" />
	/// </summary>
